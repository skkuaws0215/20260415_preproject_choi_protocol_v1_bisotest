...
| 6 | 외부검증 | ✅ | 4개 소스, 100% 신뢰도 7개 약물 |
| 7 | ADMET → Top 15 | ✅ | 40/41 PASS (97.6%) |
...
| 항목 | BRCA | Lung | Colon | 비고 |
|------|:----:|:----:|:-----:|------|
| 전체 cell line | 52 | 969 | 46 | GDSC2 기준 |
| 매칭 cell line | 52 (100%) | 578 (59.8%) | 35 (76.1%) | DepMap CRISPR과 매칭 (Colon은 raw 15→normalized 35) |
| 미매칭 원인 | - | DepMap 데이터 부재 | DepMap 데이터 부재 | Lung 391 / Colon 11 미수행 |
| 약물 수 | 295 | 295 | 295 | 동일 |
| SMILES 커버리지 | 243/295 (82.4%) | 243/295 (82.4%) | 243/295 (82.4%) | 동일 |
| IC50 measurements | ~7,730 | 148,239 | 9,692 | Lung > BRCA > Colon |
| IC50 결측 | 0 | 0 | 0 | |
| 클래스 불균형 | 70.8:29.2 | 70.9:29.1 | 70.0:30.0 | 거의 동일 (Colon 2.33:1) |
