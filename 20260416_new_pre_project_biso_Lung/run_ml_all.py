...
def run_phase_ml(input_file, output_stem, phase_name):
    ...
    # Groups 로드
    features_path = Path("/Users/skku_aws2_14/20260415_preproject_choi_protocol_v1_bisotest/20260415_preproject_choi_protocol_v1_bisotest/20260416_new_pre_project_biso_Lung/features_slim.parquet")
